  ...
  function initTriggerMenu() {
    if (menu) {
      if (menu.classList.contains('active')) {
        ...
        for (var _i2 = 0; _i2 < menuTrigger.length; _i2++) {
          menuTrigger[_i2].classList.add('active');
        }
      }
    }
  }
...
var triggerModal = /*#__PURE__*/_createClass(function triggerModal(slide, swiper) {
  _classCallCheck(this, triggerModal);
  // let instance = swiper.swiperArry[0].swiper;
  var arry = [];
  var modalTrigger = document.getElementsByClassName('trigger-modal');
  var service = [{
    title: 'Z世代の自走力強化研修',
  ...
  function initTriggerModal(e) {
    ...
    var id = elm.getAttribute('data-target');
    ...
    if (target.classList.contains('active')) {
      ...
      if (id === 'service-modal') {
        ...
        var serviceModalText = document.getElementById('service-modal-text');
        var serviceModalPoint = document.getElementById('service-modal-point');
        var pointHtml = '';
        for (var _i = 0; _i < data.point.length; _i++) {
          var thisPoint = data.point[_i];
          pointHtml += "<div class=\"point\">\n                <div class=\"point-title bg-black flex items-center\">\n                    <p class=\"text-white\">".concat(thisPoint.title, "</p>\n                </div>\n                <p class=\"point-text\">").concat(thisPoint.text, "</p>\n            </div>");
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (triggerModal);
...
var Common = /*#__PURE__*/function () {
  ...
  _createClass(Common, [{
    ...
    value: function getFeed() {
      var container = document.getElementById('case-wrapper');
      var remove_html = function remove_html(text) {
      ...
      $.ajax({
        ...
        for (var i = 0; i < items.length; i++) {
          if (i < 3) {
            var item = items[i];
            var description = remove_html(item.description);
            var thumbnail = null;
            // 文字数カウント
            ...
            html += "<div class=\"swiper-slide case relative fade-in\"><div class=\"hover\">\n                <a href=\"".concat(item.link, "\" target=\"_blank\" rel=\"noopener\" class=\"absolute center-xy sm:center-xy w-full h-full z-10\"></a>\n                <div class=\"case-image relative\">\n                    <img src=\"").concat(thumbnail, "\" alt=\"\" />\n                </div>\n                <div class=\"case-content\">\n                    <p class=\"case-title\">").concat(item.title, "</p>\n                    <div class=\"case-text\">").concat(description, "</div>\n                </div></div>\n            </div>");
          }
        }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _device_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var initSwiper = /*#__PURE__*/function () {
  function initSwiper() {
    ...
    this.deviceController = new _device_controller__WEBPACK_IMPORTED_MODULE_0__["default"]();
  }
  _createClass(initSwiper, [{
    ...
    value: function init() {
      ...
      for (var i = 0; i < swiperContainer.length; i++) {
        var excute = false;
        var thisSwiper = swiperContainer[i];
        var slides = thisSwiper.getAttribute('data-slides') === 'auto' ? 'auto' : parseFloat(thisSwiper.getAttribute('data-slides'));
        var slidesPc = thisSwiper.getAttribute('data-slidesPc') === 'auto' ? 'auto' : parseFloat(thisSwiper.getAttribute('data-slidesPc'));
        ...
        var pagination = thisSwiper.getAttribute('data-pagination') === 'true' ? {
          el: thisSwiper.parentElement.getElementsByClassName('swiper-pagination')[0]
        } : false;
        var paginationPc = thisSwiper.getAttribute('data-paginationPc') === 'true' ? {
          el: thisSwiper.parentElement.getElementsByClassName('swiper-pagination')[0]
        } : false;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initSwiper);
...
var Home = /*#__PURE__*/function () {
  ...
  _createClass(Home, [{
    ...
    value: function resizeEvent() {
      ...
      this.top.style.setProperty('--vh', "".concat(vh, "px"));
    }
  }]);
  return Home;
}();
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var lenis__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
/* harmony import */ var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
/* harmony export */ });
/* harmony import */ var _Observer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/*!
...
/* harmony export */ });
/* harmony import */ var _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var _CSSPlugin_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _device_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var scrollAnimation = /*#__PURE__*/_createClass(function scrollAnimation() {
  var _this = this;
  ...
  var about = document.getElementById('vertical');
  var addactive = document.getElementsByClassName('addactive');
  var fadeIn = document.getElementsByClassName('fade-in');
  var scrollTarget = document.getElementsByClassName('scroll-target');
  var scaleImage = document.getElementsByClassName('scale-image');
  var parallax = document.getElementsByClassName('parallax');
  var zoom = document.getElementsByClassName('zoom');
  var ratio = 832 / 1280;
  var pastW = window.innerWidth;
  this.deviceController = new _device_controller__WEBPACK_IMPORTED_MODULE_0__["default"]();
  window.scrollTo(0, 0);
  window.addEventListener("resize", function () {
    if (window.innerWidth < _this.deviceController.getDevice('sm') && pastW > _this.deviceController.getDevice('sm') || window.innerWidth > _this.deviceController.getDevice('sm')) {
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].refresh(); // Refresh ScrollTrigger on resize
    }

    pastW = window.innerWidth;
  });
  function getAmount(order, type) {
    var amount = order * window.innerHeight * .5;
    if (type === 'end') {
  ...
  for (var i = 0; i < fadeIn.length; i++) {
    ...
    var delay = elm.getAttribute('data-delay') ? parseInt(elm.getAttribute('data-delay')) * .1 : 0;
        ...
        onEnter: function onEnter() {
          if (!elm.classList.contains('active') && elm.classList.contains('typewriter')) {
            var typeWriter = function typeWriter() {
              var randomInterval = Math.floor(Math.random() * 10) + 50;
            ...
            var target = elm.getElementsByClassName('typewriter-target')[0];
            var index = 0;
            typeWriter();
          }
  ...
  for (var _i3 = 0; _i3 < zoom.length; _i3++) {
    var _elm2 = zoom[_i3];
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo(_elm2, {
      // y: 0,
      alpha: 0,
  ...
  var _loop2 = function _loop2() {
    ...
    if (window.innerWidth < _this.deviceController.getDevice('sm')) {
      amount = amountSp;
    } else {
      amount = amountPc;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var splitting__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
/* harmony import */ var _modules_trigger_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _modules_trigger_menu__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_trigger_menu__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_trigger_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _modules_device_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _modules_Common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
/* harmony import */ var _modules_init_swiper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6);
/* harmony import */ var _modules_Home__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
/* harmony import */ var _modules_lenis__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8);
/* harmony import */ var _modules_scroll_animation__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(15);
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(16);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var main = /*#__PURE__*/function () {
  function main() {
    ...
    new _modules_scroll_animation__WEBPACK_IMPORTED_MODULE_8__["default"]();
    // new triggerModal();
    // new Home();
    this.swiper = new _modules_init_swiper__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this.deviceController = new _modules_device_controller__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this.root = document.getElementById('container');
    this.lenis = new _modules_lenis__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this.lenis.init();
    this.init();
  }
  _createClass(main, [{
    ...
    value: function init() {
      ...
      this.swiper.init();
      setTimeout(function () {
        _this.root.classList.add('loaded');
      }, 100);
    }
  }]);
  return main;
